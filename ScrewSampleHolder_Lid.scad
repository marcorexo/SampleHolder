...
// Square thread.
//metric_thread (diameter=12.5, pitch=1, length=4, square=true);
...
// depth 1 mm.
//metric_thread (diameter=24, pitch=8, length=16, square=true, thread_size=6,
...
union(){
    ...
    difference(){
        difference(){
            translate([0, 0, 1.5])
            cylinder(4.5, 20, 20, center=true);
            translate([0, 0, 1.4])
            english_thread (diameter=1.23, threads_per_inch=14, length=0.4, taper=1/16);
        }
        cylinder(30, 8.4, 8.4, center=true);
    }
...
difference(){
    union(){
        cylinder(4.3, 20, 20, center=true);
        translate([0, 0, -5])
        english_thread (diameter=1.14, threads_per_inch=14, length=0.14, taper=1/16);
    }
        cylinder(40, 8.4, 8.4, center=true);
}


//translate([0, 50, 0], center=true)
//rotate([0, 0, 90])
//cube([70, 5, 4], center=true);


//%cylinder(70, 3, 3.5, center=true);  
